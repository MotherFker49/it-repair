<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 transition-colors duration-200">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('technician.search')" :active="request()->routeIs('technician.search')">
                        ค้นหางานซ่อม
                    </x-nav-link>
                    @hasrole('admin')
            ...
            <!-- Right side: Dark toggle + Settings Dropdown -->
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('technician.index')" :active="request()->routeIs('technician.index')">
                งานซ่อม
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('technician.search')" :active="request()->routeIs('technician.search')">
                ค้นหางานซ่อม
            </x-responsive-nav-link>
            @hasrole('admin')
