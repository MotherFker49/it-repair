                ...
                <form action="{{ route('equipments.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="asset_code" value="{{ old('asset_code') }}"
                                   class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-500 rounded-lg shadow-sm" placeholder="เช่น IT-2026-001">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}"
                                   class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-500 rounded-lg shadow-sm" placeholder="เช่น Notebook Dell">
                        ...
                        <div>
                            ...
                            <select name="category" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg shadow-sm">
                                <option value="computer" {{ old('category')=='computer'?'selected':'' }}>คอมพิวเตอร์</option>
                                <option value="printer" {{ old('category')=='printer'?'selected':'' }}>เครื่องพิมพ์</option>
                                <option value="network" {{ old('category')=='network'?'selected':'' }}>อุปกรณ์เครือข่าย</option>
                        ...
                        <div>
                            ...
                            <select name="status" class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg shadow-sm">
                                <option value="active" {{ old('status')=='active'?'selected':'' }}>ใช้งานปกติ</option>
                                <option value="inactive" {{ old('status')=='inactive'?'selected':'' }}>ไม่ได้ใช้งาน</option>
                                <option value="maintenance" {{ old('status')=='maintenance'?'selected':'' }}>อยู่ระหว่างซ่อม</option>
                                <option value="retired" {{ old('status')=='retired'?'selected':'' }}>เลิกใช้งานแล้ว</option>
                            </select>
                        </div>
                        ...
                        <!-- สถานที่ -->
                        <div class="relative">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">สถานที่/แผนก</label>
                        ...
                        <div>
                            ...
                            <input type="number" name="purchase_price" value="{{ old('purchase_price') }}"
                                   class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-500 rounded-lg shadow-sm" placeholder="0.00" step="0.01">
                        </div>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="note" rows="3"
                                  class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-500 rounded-lg shadow-sm"
                                  placeholder="ข้อมูลเพิ่มเติม...">{{ old('note') }}</textarea>
                    </div>
                    ...
                    <div class="flex gap-3 mt-6">
                        ...
                        <a href="{{ route('equipments.index') }}" class="bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 px-6 py-2 rounded-lg transition-colors">
                            ยกเลิก
                        </a>
                    </div>
